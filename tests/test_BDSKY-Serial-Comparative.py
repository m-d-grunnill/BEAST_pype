...
class TestBDSKYSerialComparativeFull(ComparativeWorkflowVariationTest):
    ...
    parameters_path = 'tests/parameters/BDSKY-Serial-Comparative_full.yml'
    workflow = workflow
...
class TestBDSKYSerialComparativeNoDownsampling(ComparativeWorkflowVariationTest):
    ...
    parameters_path = 'tests/parameters/BDSKY-Serial-Comparative_no_downsampling.yml'
    workflow = workflow
    initial_tree_building =True
    xml_generation = True
    xml_generation_notebook = xml_generation_notebook
...
class TestBDSKYSerialComparativeChangeTimes(ComparativeWorkflowVariationTest):
    ...
    parameters_path = 'tests/parameters/BDSKY-Serial-Comparative_partitions.yml'
    workflow = workflow
    initial_tree_building = True
    xml_generation = True
    xml_generation_notebook = xml_generation_notebook
...
class TestBDSKYSerialComparativeNoInitialTree(ComparativeWorkflowVariationTest):
    ...
    parameters_path = 'tests/parameters/BDSKY-Serial-Comparative_no-initial-tree.yml'
    workflow = workflow
    xml_generation = True
    xml_generation_notebook = xml_generation_notebook